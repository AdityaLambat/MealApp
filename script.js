...
// Creates Array List of Favourite Meal
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}

// Serach Meal From API and Return That Meal
...
// Function To Show List Of All Meals Searched By User
            ...
            data.meals.forEach((element) => {
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-light" onclick="showMealDetails(${element.idMeal})">More Details</button>
                            <button id="main${element.idMeal}" class="btn btn-outline-light" onclick="addRemoveToFavList(${element.idMeal})" style="border-radius:50%"><i class="fa fa-heart"></i></button>
                        </div>
                    </div>
                </div>
                `;
...
//Function To Show Details Of Meal Searched By User
        ...
        html += `
          <div id="meal-details" class="mb-5">
            <div id="meal-header" class="d-flex justify-content-around flex-wrap">
              <div>
                <img class="mb-2" src="${data.meals[0].strMealThumb}" width="200" height="200" alt="" srcset="">
              </div>
              <div id="details">
            ...
            <div id="meal-recipes" class="mt-3">
              <h5 class="text-center">Recipe</h5>
...
//Function To Show All Favourite Meals Of User
async function showFavMealList() {
    ...
    if (arr.length == 0) {
        ...
        for (let index = 0; index < arr.length; index++) {
            await fetchMealsFromApi(url, arr[index]).then(data => {
                html += `
                <div id="card" class="card mb-2" style="width: 20rem;">
    ...
    document.getElementById("favourite-meal").innerHTML = html;
}

//Function To Add Or Remove Meal From Favourite List
function addRemoveToFavList(id) {
    ...
    if (contain) {
        ...
        arr.splice(number, 1);
        alert("Meal Removed From Favourite List Successfully !!!");
    }
    else {
        arr.push(id);
        alert("Your Meal is Added To Your Favourites List Successfully !!!");
    }
